# Course Final Project guide installation
...
To move beyond notebook prototyping, all reusable code should go into the `course_final_project/` folder package. To use that package inside your project, install the project's module in editable mode, so you can edit files in the `course_final_project` folder and use the modules inside your notebooks :
...
```python
from course_final_project.utils.paths import data_dir
data_dir()
```
